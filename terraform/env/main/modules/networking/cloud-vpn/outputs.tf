...
output "project" {
  description = "HA VPN Project ID."
  value       = google_compute_ha_vpn_gateway.ha_gateway.project
}

output "region" {
  description = "HA VPN gateway resource."
  value       = google_compute_ha_vpn_gateway.ha_gateway.region
}

output "network" {
  description = "HA VPN gateway resource."
  value       = google_compute_ha_vpn_gateway.ha_gateway.network
}
