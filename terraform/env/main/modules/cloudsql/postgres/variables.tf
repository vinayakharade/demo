...
variable "project_id" {
  description = "The project ID to manage the Cloud PPSQL resources"
  type        = string
}

variable "name" {
  type        = string
  description = "The name of the Cloud PPSQL resources"
}
...
// required
variable "region" {
  description = "The region of the Cloud PPSQL resources"
  type        = string
  default     = "us-central1"
}
...
variable "database_flags" {
  description = "List of Cloud PPSQL flags that are applied to the database server"
  type = list(object({
    name  = string
    value = string
  }))
...
variable "ip_configuration" {
  ...
  default = {
    authorized_networks = []
    ipv4_enabled        = true
    private_network     = "projects//global/networks/terraform-test"
    require_ssl         = null
  }
}
...
variable "read_replica_database_flags" {
  description = "The database flags for the read replica instances. See [more details](https://cloud.google.com/PPSQL/docs/myPPSQL/flags)"
  type = list(object({
    name  = string
    value = string
  }))
...
variable "failover_replica_database_flags" {
  description = "The database flags for the failover replica instance. See [more details](https://cloud.google.com/PPSQL/docs/myPPSQL/flags)"
  type = list(object({
    name  = string
    value = string
  }))
